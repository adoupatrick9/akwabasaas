                ...
                <div class="tabs">
                    ...
                    <div class="tabs__content-wrapper">
                        <div class="tabs__content tabs_active">
                            ...
                            <div class="col-md-3 form-group genreE">
                        ...
                        <div class="tabs__content" >
                            ...
                            <div class="col-md-6 form-group">
                                Téléphone fix<input type="phone" name="ap_telephone_pers" id="ap_telephone_pers" autocomplete="on" class="form-control placeholder-no-fix" value="{{ old('ap_telephone_pers') }}">
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="modal-footer col-md-12">
                                ...
                                <button class="btn btn-theme" type="submit" id="submit">Modifier <i class="fa fa-save"></i></button>
                            </div>
                            </form>
                        </div>
                        <div class="tabs__content">
