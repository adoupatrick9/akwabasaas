<form action="{{ url('/utilisateurs-portefeuille-create/'.$IDpartenaire.'/partenaire') }}" method="post" style="margin-top: 50px;">
    @csrf
    <!-- Modal -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body row">
                <div class="col-md-12 form-group">
                    <span>Nouveau client <input type="checkbox" checked name="new" id="new"></span>
                </div>
                <div class="col-md-12" id="nouveauClient">
                    <div class="col-md-3 form-group">
                        Type personne<span class="text-danger">*</span><select name="ap_type_pers" id="ap_type_pers" class="form-control">
                            <option value="1">Pysique</option>
                    ...
                    <div class="tabs">
                        ...
                        <div class="tabs__content-wrapper">
                            <div class="tabs__content tabs_active">
                                ...
                                <div class="col-md-6 form-group">
                                    Téléphone<input type="phone" name="ap_telephone_pers" autocomplete="on" class="form-control placeholder-no-fix" value="{{ old('ap_telephone_pers') }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    Mobile <span class="text-danger">*</span><input type="phone" name="ap_mobile_pers" autocomplete="on" class="form-control placeholder-no-fix" value="{{ old('ap_mobile_pers') }}">
                                </div>
                                <div class="col-md-6 form-group">
                                ...
                                <div class="col-md-6 form-group">
                                    Type pièce <select name="ap_typepiece_pers" id="ap_typepiece_pers" class="form-control">
                                        ...
                                        <option value="registre de commerce des sociétés" id="pmCache">registre de commerce des sociétés</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                            ...
                            <div class="tabs__content" >
                                ...
                                <div class="col-md-6 form-group">
                                    Pays <span class="text-danger">*</span><input type="text" name="ap_pays_pers" autocomplete="on" class="form-control placeholder-no-fix" value="{{ old('ap_pays_pers') }}">
                                </div>
                                <div class="col-md-6 form-group">
                ...
                <div class="col-md-12" id="ancientClient">
                    <div class="col-md-12 form-group">
                        Client<span class="text-danger">*</span><select name="ap_matricule_pers" id="ap_matricule_pers" class="form-control">
                            <option value="">Choisir ...</option>
                            @foreach($clients as $client)
                                <option value="{{ $client['ap_matricule_pers'] }}">{{ $client['NomComplet'] }}</option>
                            @endforeach
                        </select>
                    </div>
