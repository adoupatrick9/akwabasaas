          ...
          @csrf
            ...
            <div class="modal-body row">
                ...
                <div class="col-md-6 form-group">
                    Devise <em class="text-danger">*</em><select name="dev_code_devise" class="form-control placeholder-no-fix">
                ...
                <div class="col-md-6 form-group">
                    Type service<em class="text-danger">*</em><select name="cs_type_service" class="form-control placeholder-no-fix">
